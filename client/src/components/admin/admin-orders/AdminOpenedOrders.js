...
import { getAllOpenedOrders } from '../../../actions/order'
import formateDate from '../../../utils/formatDate'
import calculateTimeStatus from '../../../utils/calculateTimeStatus'
import Spinner from '../../layout/Spinner'

const AdminOpenedOrders = ({ getAllOpenedOrders, orders, isLoading }) => {
...
export default connect(mapStateToProps, { getAllOpenedOrders })(AdminOpenedOrders)