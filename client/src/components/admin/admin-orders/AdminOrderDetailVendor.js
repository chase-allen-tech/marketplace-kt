...
const AdminOrderDetailVendor = ({ vendor, orderItems, addTrackingNumber, orderID }) => {
...
export default connect(mapStateToProps, { addTrackingNumber })(AdminOrderDetailVendor)