      ...
      <div className='row'>
        <div className='col-lg-6'>
          <div className='d-flex align-items-center pt-3'>
            ...
            <Link to='product-create'><i className='fa fa-plus-circle font-24 cursor-pointer pt-2'></i></Link>
          </div>
        </div>
        <div className='col-lg-6'>
                  ...
                  <table className='table table-borderless'>
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td>
                          <Link to={`/product-edit/${item._id}`} className='btn bg-keto-secondary mr-1'>
