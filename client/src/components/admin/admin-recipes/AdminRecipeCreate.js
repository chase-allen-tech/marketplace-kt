...
const AdminRecipeCreate = ({ createRecipe, setAlert }) => {
  ...
  return (
    <div className='admin-recipe-create'>
      <div className='font-36 pt-3'>Create Recipe</div>
...
export default connect(mapStateToProps, { createRecipe, setAlert })(AdminRecipeCreate)